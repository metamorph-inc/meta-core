...
%META_PYTHON_PATH% scripts\update_settings.py || goto :ERROR_SECTION
%META_PYTHON_PATH% scripts\fov.py || goto :ERROR_SECTION
%META_PYTHON_PATH% scripts\update_summary.py || goto :ERROR_SECTION
