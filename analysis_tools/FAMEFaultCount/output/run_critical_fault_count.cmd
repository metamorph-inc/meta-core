...
reg.exe query "HKLM\software\META" /v "META_PATH" /reg:64
...
IF %QUERY_ERRORLEVEL% == 0 (
    ...
    %META_PYTHON_EXE% scripts\reorganizePossibleFault.py 1>> output 2>>&1
    %META_PYTHON_EXE% scripts\Dymola_FAME_Simulation.py 1>> output 2>>&1
    %META_PYTHON_EXE% scripts\postprocessCriticalFaults.py
