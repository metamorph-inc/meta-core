...
#define OP_SUM			700l			/* tbd skn mtbdd sum op */
#define OP_SUB			800l			/* tbd skn mtbdd sub op */
#define OP_MAX			900l			/* tbd skn mtbdd max op */
#define OP_QNT			10000l
#define OP_RELPROD		11000l
#define OP_SUBST		12000l
#define OP_COMP			130000l
#define OP_CMPTO		140000l
#define OP_SWAP			150000l
#define OP_SWAPAUX		160000l
#define OP_THRESH		170000l			/* tbd skn mtbdd thresh op */
#define OP_LTHRESH		180000l
#define OP_MUL			190000l
#define OP_DIVBY		200000l
#define OP_ROOTBY		210000l
#define OP_MIN			220000l
#define OP_EQUALSTO		230000l
#define OP_NEQUALSTO	240000l
#define OP_SUM_THRESH	250000l
#define OP_MUL_THRESH	260000l
#define OP_DIV			270000l
#define OP_SUMBY		280000l
#define OP_SUBBY		290000l
#define OP_MULBY		300000l
#define OP_DIV_FROM		310000l

#define MAX_CACHE_OFFSET	OP_NEQUALSTO - 	OP_EQUALSTO - 1
