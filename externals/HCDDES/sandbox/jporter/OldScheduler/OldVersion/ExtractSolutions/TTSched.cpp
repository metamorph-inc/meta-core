...
// generated on Thu Apr 12 20:29:50 2007
...
namespace TTSched {
	...
	::Uml::Diagram umldiagram;
		...
		void InitComposition26()
		{
			...
			::TTSched::Bus::meta_Dependencies_child = ::Uml::CompositionChildRole::Create(comp);
			::TTSched::Bus::meta_Dependencies_child.name() = "Dependencies";
			::TTSched::Bus::meta_Dependencies_child.min() = 0;
			::TTSched::Bus::meta_Dependencies_child.max() = 1;
			::TTSched::Bus::meta_Dependencies_child.isNavigable() = true;
			::TTSched::Bus::meta_Dependencies_child.target() = ::TTSched::Dependencies::meta;
		}
	 ...
	 void InitializeDgr()
	{
		 ...
		 void InitializeDgr(const ::Uml::Diagram & dgr)
		{
			...
			::Uml::SetChildRole(Bus::meta_Dependencies_child,Bus::meta,::TTSched::Dependencies::meta, "", "");
