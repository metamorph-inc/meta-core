...
namespace TTSched {
	extern  Udm::UdmDiagram diagram;
	 ...
	 void Initialize();
		...
		class  SerialConstraint :  public ::TTSched::Constraint, public ::TTSched::Connectable {
		public:
			static ::Uml::Class meta;

			SerialConstraint() { }
			SerialConstraint(Udm::ObjectImpl *impl) : ::TTSched::Constraint(impl),::TTSched::Connectable(impl), ::TTSched::MgaObject(impl) { }
			SerialConstraint(const SerialConstraint &master) : ::TTSched::Constraint(master),::TTSched::Connectable(master), ::TTSched::MgaObject(master) { }
		...
		class  RangeConstraint :  public ::TTSched::Constraint, public ::TTSched::Connectable {
		public:
			static ::Uml::Class meta;

			RangeConstraint() { }
			RangeConstraint(Udm::ObjectImpl *impl) : ::TTSched::Constraint(impl),::TTSched::Connectable(impl), ::TTSched::MgaObject(impl) { }
			RangeConstraint(const RangeConstraint &master) : ::TTSched::Constraint(master),::TTSched::Connectable(master), ::TTSched::MgaObject(master) { }
		...
		public:
			...
			static ::Uml::CompositionChildRole meta_Dependencies_children;
			Udm::ChildrenAttr< ::TTSched::Dependencies> Dependencies_children() const { return Udm::ChildrenAttr< ::TTSched::Dependencies>(impl, meta_Dependencies_children); }
			template <class Pred> Udm::ChildrenAttr< ::TTSched::Dependencies, Pred> Dependencies_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::TTSched::Dependencies, Pred>(impl, meta_Dependencies_children); }
