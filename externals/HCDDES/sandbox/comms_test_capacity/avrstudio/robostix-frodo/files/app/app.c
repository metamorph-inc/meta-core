...
void app_tasks_init() { 
	...
	input_bufs.gps_buf.header = 108;
	input_bufs.gps_buf.DataHandler_data2[0] = 1.0;
    input_bufs.gps_buf.DataHandler_data2[1] = -1.0;
	input_bufs.gps_buf.DataHandler_data2[2] = 1.1;
	input_bufs.gps_buf.DataHandler_data2[3] = -1.1;
	input_bufs.gps_buf.DataHandler_data2[4] = 0.5;
	input_bufs.gps_buf.DataHandler_data2[5] = -0.5;


    input_bufs.imu_buf.header = 147;
    input_bufs.imu_buf.DataHandler_data1[0] = -1.0;
	input_bufs.imu_buf.DataHandler_data1[1] = 1.0;
	input_bufs.imu_buf.DataHandler_data1[2] = -2.0;
	input_bufs.imu_buf.DataHandler_data1[3] = 2.0;
	input_bufs.imu_buf.DataHandler_data1[4] = 0.7;
	input_bufs.imu_buf.DataHandler_data1[5] = -0.7;
	input_bufs.imu_buf.DataHandler_data1[6] = 8.0;
	input_bufs.imu_buf.DataHandler_data1[7] = -8.0;
	input_bufs.imu_buf.DataHandler_data1[8] = 30.0;
...
msg_entry msgs[] = {
   ...
   { 1, MSG_DIR_SEND, sizeof( DataHandler_Pos_Data_msg ), (portCHAR *) & DataHandler_Pos_Data_msg, (portCHAR *) & DataHandler_Pos_Data_msg_c, 8, pdFALSE},
   { 2, MSG_DIR_RECV, sizeof( OuterLoop_Att_Ref_msg ), (portCHAR *) & OuterLoop_Att_Ref_msg, (portCHAR *) & OuterLoop_Att_Ref_msg_c, 15, pdFALSE},
   { -1, 0, 0, NULL, NULL, 0, 0}
};
...
per_entry pers[] = {
   ...
   { 3, "UART", OUT, 1, 0, sizeof(InnerLoop_Thrust_Cmd_msg_t), (portCHAR *) &InnerLoop_Thrust_Cmd_msg, (portCHAR *) &InnerLoop_Thrust_Cmd_msg_c, 18, NULL, NULL, 147},
