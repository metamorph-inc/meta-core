...
#include "Ssignal1CA9singleACsignal2CA6singleAS.h"
...
#ifndef DataHandler_100000171_context_GUARD
#define DataHandler_100000171_context_GUARD
typedef struct {
  int Gain921[12][15];
  double Gain983;
  int Gain1177[6][15];
  double Gain1206;
} DataHandler_100000171_context;
#endif
