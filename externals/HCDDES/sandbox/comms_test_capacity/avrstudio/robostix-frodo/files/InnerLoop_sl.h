...
#include "Ssignal1CA4singleACsignal2CA6singleAS.h"
...
#ifndef InnerLoop_100000159_context_GUARD
#define InnerLoop_100000159_context_GUARD
typedef struct {
  int Gain379[4][10];
  double Gain950;
} InnerLoop_100000159_context;
#endif

/* SIMPLIFIED PROGRAM CONTEXT */
typedef InnerLoop_100000159_context InnerLoop_context;
