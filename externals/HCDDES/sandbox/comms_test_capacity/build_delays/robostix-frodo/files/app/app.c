...
typedef struct {
    ...
    float RefSocketHandler_raw_pos_ref[4];
...
msg_entry msgs[] = {
   ...
   { 1, MSG_DIR_SEND, sizeof( OuterLoop_Att_Ref_msg ), (portCHAR *) & OuterLoop_Att_Ref_msg, (portCHAR *) OuterLoop_Att_Ref_msg_c, 3, pdFALSE},

   { 2, MSG_DIR_RECV, sizeof( DataHandler_Pos_Data_msg ), (portCHAR *) & DataHandler_Pos_Data_msg, (portCHAR *) DataHandler_Pos_Data_msg_c, 14, pdFALSE},
...
per_entry pers[] = {
   ...
   { 1, "UART", IN, 0, 0, sizeof( DataHandler_PL_IMU_GPS_msg ), (portCHAR *) &DataHandler_PL_IMU_GPS_msg, (portCHAR *) DataHandler_PL_IMU_GPS_msg_c, 2, NULL, 0, 0 },

   { 2, "UART", OUT, 0, 0, sizeof( InnerLoop_Thrust_Cmd_msg ), (portCHAR *) &InnerLoop_Thrust_Cmd_msg, (portCHAR *) InnerLoop_Thrust_Cmd_msg_c, 13, NULL, 0, 0 },
