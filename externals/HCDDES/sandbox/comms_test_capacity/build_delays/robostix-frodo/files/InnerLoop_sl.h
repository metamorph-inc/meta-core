...
#include "Ssignal1CA4floatACsignal2CA6floatAS.h"
...
#ifndef InnerLoop_100000156_context_GUARD
#define InnerLoop_100000156_context_GUARD
typedef struct {
  float Gain707[4][10];
  float Gain907;
} InnerLoop_100000156_context;
#endif

/* SIMPLIFIED PROGRAM CONTEXT */
typedef InnerLoop_100000156_context InnerLoop_context;
