...
void app_tasks_init() { 
   ...
   RefSocketHandler_init( &RefSocketHandler_ctxt );
...
task_entry tasks[] = {
   ...
   { OuterLoop, "OuterLoop", 11 },
   {NULL, NULL, 0, 0}
};

msg_entry msgs[] = {

   { 1, MSG_DIR_SEND, sizeof( OuterLoop_Att_Ref_msg ), (portCHAR *) & OuterLoop_Att_Ref_msg, 3 },
   { 2, MSG_DIR_RECV, sizeof( DataHandler_Pos_Data_msg ), (portCHAR *) & DataHandler_Pos_Data_msg, 14 },
   { -1, 0, 0, NULL, 0}
};
