...
#include "Ssignal1CA9floatACsignal2CA6floatAS.h"
...
#ifndef DataHandler_100000155_context_GUARD
#define DataHandler_100000155_context_GUARD
typedef struct {
  float Gain599[12][15];
  float Gain891;
  float Gain1119[6][15];
  float Gain1147;
} DataHandler_100000155_context;
#endif

/* SIMPLIFIED PROGRAM CONTEXT */
typedef DataHandler_100000155_context DataHandler_context;
