...
void* Task1_exec( void *cntx ) {
	...
	for ( ; ; ) {
		...
		context->udpSend_msg.pos_data += 0.05; // context->syncUDPIn_msg.pos_data + 0.1;
...
int main(void) {
	...
	{
		pfloat_t msg1_stimes[1] = { 13.0 };
		pfloat_t msg1_rtimes[2] = { 2.0, 8.0 };
