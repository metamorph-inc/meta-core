...
def read_msg_file(job_name):
    ...
    with open(fname,'rb') as msg:
        ...
        if (m.find(" ***NOTE: THE SOLUTION APPEARS TO BE DIVERGING. CONVERGENCE IS JUDGED UNLIKELY.") != -1
            ...
            logger.info("UNKNOWN ENDING CONDITION: Please look at abaqus msg file.\n")
