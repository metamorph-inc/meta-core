...
#
# Generated Fri Feb 13 10:09:56 2015 by generateDS.py version 2.12d.
#
...
#
# Command line:
#   C:\Users\snyako.ISIS\Desktop\generateDS-2.12d\generateDS.py -o "a" CADPostProcessingParameters.xsd
#
...
class MetricType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, _instances=None, _derived=None, _real_archetype=None, _desynched_atts=None, Type=None, MetricID=None, _subtype=None, DataFormat=None, _archetype=None, Units=None, _id=None, ArrayValue=None, MetricName=None):
        self.original_tagname_ = None
        self._instances = _cast(None, _instances)
        self._derived = _cast(None, _derived)
        self._real_archetype = _cast(bool, _real_archetype)
