...
#define ISIS_PRODUCT_VERSION  1,5,28,0
#define ISIS_FILE_VERSION ISIS_PRODUCT_VERSION
#define ISIS_STR_PRODUCT_VERSION "CADCreoParametricCreateAssembly 1.5.28.0\0"
#define ISIS_PRODUCT_VERSION_WITH_v_AND_DOTS "v1.5.28.0"
