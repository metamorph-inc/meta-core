...
const StatusDefinition Stats[] = 
{
	...
	{SD_PREAPPLY,	_T("Verifying and analyzing constraints"),		72},
	{SD_APPLY,	_T("Applying constraints"),					74 },
	{SD_COUNT,	_T("Counting configurations"),				76 },
	{SD_GUI,	_T("Invoking Desert GUI"),					78},
	{SD_PREP,	_T("Preparing output"),						80},
