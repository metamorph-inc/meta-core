...
# Generated 2013-09-18 10:36:00.387704 by PyXB version 1.2.3
...
class STD_ANON (pyxb.binding.datatypes.Name, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.FvaD3zy/PyXB-1.2.3/pyxb/bundles/dc/schemas/dcmitype.xsd', 33, 8)
    _Documentation = None
...
class DCMIType (pyxb.binding.basis.STD_union):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.FvaD3zy/PyXB-1.2.3/pyxb/bundles/dc/schemas/dcmitype.xsd', 31, 2)
    _Documentation = None
