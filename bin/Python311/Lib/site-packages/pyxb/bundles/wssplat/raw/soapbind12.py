...
# Generated 2017-09-03 06:16:46.121793 by PyXB version 1.2.6 using Python 2.7.12.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:5f442600-9099-11e7-b77e-3497f68b2e96')
...
class tStyleChoice (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 46, 2)
    _Documentation = None
...
_module_typeBindings.tStyleChoice = tStyleChoice
...
class tParts (pyxb.binding.basis.STD_list):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 71, 2)
    _Documentation = None

    _ItemType = pyxb.binding.datatypes.NMTOKEN
tParts._InitializeFacetMap()
Namespace.addCategoryObject('typeBinding', 'tParts', tParts)
_module_typeBindings.tParts = tParts
...
class useChoice (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 83, 2)
    _Documentation = None
...
_module_typeBindings.useChoice = useChoice
...
class tExtensibilityElementOpenAttrs (pyxb.bundles.wssplat.wsdl11.tExtensibilityElement):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 28, 2)
...
_module_typeBindings.tExtensibilityElementOpenAttrs = tExtensibilityElementOpenAttrs
...
class tBinding (tExtensibilityElementOpenAttrs):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 37, 2)
    ...
    __transport._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 40, 8)
    __transport._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 40, 8)
    
    transport = property(__transport.value, __transport.set, None, None)

    
    # Attribute style uses Python identifier style
    __style = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'style'), 'style', '__httpschemas_xmlsoap_orgwsdlsoap12_tBinding_style', _module_typeBindings.tStyleChoice)
    __style._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 41, 8)
    __style._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 41, 8)
...
class tOperation (tExtensibilityElementOpenAttrs):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 54, 2)
    _ElementMap = tExtensibilityElementOpenAttrs._ElementMap.copy()
    _AttributeMap = tExtensibilityElementOpenAttrs._AttributeMap.copy()
    # Base type is tExtensibilityElementOpenAttrs
    ...
    __soapAction._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 57, 8)
    __soapAction._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 57, 8)
    ...
    __soapActionRequired._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 58, 8)
    __soapActionRequired._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 58, 8)
    
    soapActionRequired = property(__soapActionRequired.value, __soapActionRequired.set, None, None)

    
    # Attribute style uses Python identifier style
    __style = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'style'), 'style', '__httpschemas_xmlsoap_orgwsdlsoap12_tOperation_style', _module_typeBindings.tStyleChoice)
    __style._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 59, 8)
    __style._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 59, 8)
...
class tBody (tExtensibilityElementOpenAttrs):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 74, 2)
    _ElementMap = tExtensibilityElementOpenAttrs._ElementMap.copy()
    _AttributeMap = tExtensibilityElementOpenAttrs._AttributeMap.copy()
    # Base type is tExtensibilityElementOpenAttrs
    ...
    __encodingStyle._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 67, 4)
    __encodingStyle._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 67, 4)
    
    encodingStyle = property(__encodingStyle.value, __encodingStyle.set, None, None)

    
    # Attribute use uses Python identifier use
    __use = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'use'), 'use', '__httpschemas_xmlsoap_orgwsdlsoap12_tBody_use', _module_typeBindings.useChoice)
    __use._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 68, 4)
    __use._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 68, 4)
    ...
    __namespace._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 69, 4)
    __namespace._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 69, 4)
    
    namespace = property(__namespace.value, __namespace.set, None, None)

    
    # Attribute parts uses Python identifier parts
    __parts = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'parts'), 'parts', '__httpschemas_xmlsoap_orgwsdlsoap12_tBody_parts', _module_typeBindings.tParts)
    __parts._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 77, 8)
    __parts._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 77, 8)
...
_module_typeBindings.tBody = tBody
...
class tHeader (tExtensibilityElementOpenAttrs):
    ...
    __message._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 111, 4)
    __message._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 111, 4)
    ...
    __part._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 112, 4)
    __part._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 112, 4)
    
    part = property(__part.value, __part.set, None, None)

    
    # Attribute use uses Python identifier use
    __use = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'use'), 'use', '__httpschemas_xmlsoap_orgwsdlsoap12_tHeader_use', _module_typeBindings.useChoice, required=True)
    __use._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 113, 4)
    __use._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 113, 4)
    ...
    __encodingStyle._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 114, 4)
    __encodingStyle._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 114, 4)
    ...
    __namespace._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 115, 4)
    __namespace._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 115, 4)
...
_module_typeBindings.tHeader = tHeader
...
class tHeaderFault (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 129, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    # Attribute use uses Python identifier use
    __use = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'use'), 'use', '__httpschemas_xmlsoap_orgwsdlsoap12_tHeaderFault_use', _module_typeBindings.useChoice, required=True)
    __use._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 113, 4)
    __use._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 113, 4)
...
_module_typeBindings.tHeaderFault = tHeaderFault
...
class tAddress (tExtensibilityElementOpenAttrs):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 135, 2)
    _ElementMap = tExtensibilityElementOpenAttrs._ElementMap.copy()
    _AttributeMap = tExtensibilityElementOpenAttrs._AttributeMap.copy()
    # Base type is tExtensibilityElementOpenAttrs
    ...
    __location._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 138, 8)
    __location._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 138, 8)
...
_module_typeBindings.tAddress = tAddress
...
class tFaultRes (tBody):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 91, 2)
    ...
    __required._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 94, 5)
    ...
    # Attribute parts uses Python identifier parts
    __parts = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'parts'), 'parts', '__httpschemas_xmlsoap_orgwsdlsoap12_tBody_parts', _module_typeBindings.tParts, prohibited=True)
    __parts._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 95, 8)
    __parts._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 95, 8)
...
_module_typeBindings.tFaultRes = tFaultRes
...
class tFault (tFaultRes):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 100, 2)
    ...
    __name._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 103, 8)
    __name._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 103, 8)
...
binding = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'binding'), tBinding, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 36, 2))
Namespace.addCategoryObject('elementBinding', binding.name().localName(), binding)

operation = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operation'), tOperation, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 53, 2))
Namespace.addCategoryObject('elementBinding', operation.name().localName(), operation)

body = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'body'), tBody, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 64, 2))
Namespace.addCategoryObject('elementBinding', body.name().localName(), body)

header = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'header'), tHeader, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 109, 2))
Namespace.addCategoryObject('elementBinding', header.name().localName(), header)

headerfault = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'headerfault'), tHeaderFault, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 128, 2))
Namespace.addCategoryObject('elementBinding', headerfault.name().localName(), headerfault)

address = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'address'), tAddress, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 134, 2))
Namespace.addCategoryObject('elementBinding', address.name().localName(), address)

fault = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'fault'), tFault, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 90, 2))
Namespace.addCategoryObject('elementBinding', fault.name().localName(), fault)



tHeader._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'headerfault'), tHeaderFault, scope=tHeader, location=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 128, 2)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 121, 10))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(tHeader._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'headerfault')), pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/wssplat/schemas/soapbind12.xsd', 121, 10))
