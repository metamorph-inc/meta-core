...
# Generated 2017-09-03 06:16:51.128431 by PyXB version 1.2.6 using Python 2.7.12.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:6244a514-9099-11e7-b77e-3497f68b2e96')
...
class DCEValueType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/saml20/schemas/dce.xsd', 18, 4)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __Realm._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/saml20/schemas/dce.xsd', 26, 4)
    __Realm._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/saml20/schemas/dce.xsd', 21, 16)
    ...
    __FriendlyName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/saml20/schemas/dce.xsd', 27, 4)
    __FriendlyName._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.WUiBAra/PyXB-1.2.6/pyxb/bundles/saml20/schemas/dce.xsd', 22, 16)
