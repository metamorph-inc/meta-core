// Generated by SolidPython 0.1 on 2019-10-13 15:57:06
...
class TestSolidPython(DiffOutput):
    ...
    def test_scad_render_to_file(self):
        ...
        with TemporaryFileBuffer() as tmp:
            out_dir = Path(tmp.name).cwd()
            out_path = scad_render_to_file(a, out_dir=out_dir)
            self.assertEqual(tmp.name, out_path)
