...
class matlabarray(np.ndarray):
    ...
    def __getitem__(self,index):
        if type(index) is slice and index.start is None and index.stop is None:
            return self.reshape(-1, 1, order="F")
    ...
    def sizeof(self,ix):
        if isinstance(ix,int):
            ...
            assert 0,ix
        if not isinstance(n,int) and not isinstance(n, np.int32):
            raise IndexError
        return n
    ...
    def __setitem__(self,index,value):
        ...
        try:
            ...
            if not self.size:
                ...
                new_shape = list(self.shape)
                # FIXME numpy changed this between 1.10 and 1.12. What is this trying to test?
